/*
	...
	Version 4.74 - October 18, 2011
	(c)1995-2011 - Santa Barbara Instrument Group
...
typedef enum { DCP_USB_FIFO_ENABLE, DCP_CALL_JOURNAL_ENABLE,
	...
	DCP_VERT_FLUSH_CONTROL_ENABLE, DCP_ETHERNET_PIPELINE_ENABLE, DCP_FAST_LINK, 
	DCP_OVERSCAN_ROWSCOLS, DCP_PIXEL_PIPELINE_ENABLE, DCP_COLUMN_REPAIR_ENABLE,
	DCP_WARM_PIXEL_REPAIR_ENABLE, DCP_WARM_PIXEL_REPAIR_COUNT, DCP_LAST } DRIVER_CONTROL_PARAM;
...
typedef enum { CFWSEL_UNKNOWN, CFWSEL_CFW2, CFWSEL_CFW5, CFWSEL_CFW8, CFWSEL_CFWL,
	...
	CFWSEL_CFW1603, CFWSEL_FW5_STX, CFWSEL_FW5_8300,
	CFWSEL_FW8_8300 } CFW_MODEL_SELECT;
...
typedef struct {
	unsigned short /* DIFF_GUIDER_COMMAND */ diffGuiderCommand;
...
typedef struct {
	unsigned short /* DIFF_GUIDER_ERROR */ diffGuiderError;
	unsigned short /* DIFF_GUIDER_STATUS */ diffGuiderStatus;
